...
export class Text extends Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes>, import("three").Material | import("three").Material[], import("three").Object3DEventMap> {
    constructor();
    /**
     * @member {string} text
   ...
   */
     ...
     */
    get textRenderInfo(): TroikaTextRenderInfo
